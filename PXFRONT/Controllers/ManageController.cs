...
using PXFRONT.Extensions;
using PXFRONT.Models;
using PXFRONT.Models.ManageViewModels;
...
namespace PXFRONT.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, ILogger<ManageController> logger,
