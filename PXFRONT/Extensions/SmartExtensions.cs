...
using System;
using PXFRONT.Configuration;

// ReSharper disable MemberCanBePrivate.Global

#endregion

namespace PXFRONT.Extensions
{
    /// <summary>
    ...
    public static class SmartExtensions
    {
        ...
        /// <summary>
        /// Checks if the current hosting environment name is <see cref="F:PXFRONT.Configuration.EnvironmentName.Demo" />.
        /// </summary>
        /// <param name="hostingEnvironment">A string value representing the hosting environment.</param>
        /// <returns><c>True</c> if the environment name is <see cref="F:PXFRONT.Configuration.EnvironmentName.Demo" />, otherwise <c>false</c>.</returns>
